...
<cfif isDefined("url.ead")>
	...
	<cfscript>
	WriteOutput("&lt;p&gt;" & replbr("display",replent(srch2.relatedMat)) & "&lt;/p&gt;<br>") ;
	</cfscript>
	</cfoutput>
	<cfscript>
	...
	<br>
	<a href="fa_related.cfm?id=<cfoutput>#m_collid#</cfoutput>" class="go2">RETURN</a>
<!--- end EAD DISPLAY --->
<cfelse>
...
<cfoutput query="srch2">
	...
	<cfif srch2.ID is "#m_pID#" and m_t is "edit">
		<textarea wrap="virtual" 
			...
			rows="5" 
			cols="50"
			class="general">#srch2.relatedMat#</textarea><br><br>
	...
	<cfelse>
		<cfif m_t is "disp" and (session.loginType is "edit" or session.loginType is "admin" or session.loginType is "sys")>
			<a href="fa_related.cfm?id=#m_collid#&t=new&id1=#pr_ID1#&id2=#pr_ID2#" class="go2">INSERT PARAGRAPH</a>
			<br><br>
		</cfif>
		#relatedMat# 
		<cfif m_t is "disp" and (session.loginType is "edit" or session.loginType is "admin" or session.loginType is "sys")>
			[<a href="fa_related.cfm?id=#m_collid#&pid=#srch2.ID#&t=edit" class="go2">EDIT</a>][<a href="fa_deleteRelated.cfm?id=#m_collid#&pid=#srch2.ID#" class="go2" onClick="return confirm('Delete this item?')">DELETE</a>]
		</cfif>
		<br><br>
	</cfif>
	<cfset pr_ID1=srch2.relMatOrd>
</cfoutput>
...
<cfelse>
	<cfif session.loginType is "edit" or session.loginType is "admin" or session.loginType is "sys">
		<a href="fa_related.cfm?id=<cfoutput>#m_collid#</cfoutput>&t=new&id1=0&id2=0" class="go2">ADD PARAGRAPH</a> /
	</cfif>
	<a href="fa_related.cfm?id=<cfoutput>#m_collid#</cfoutput>&ead=1" class="go2">DISPLAY EAD</a>
</cfif>
